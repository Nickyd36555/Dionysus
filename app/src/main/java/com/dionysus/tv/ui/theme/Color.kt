...
val DionysusSurface = Color(0xFF1A1116)       // deep wine
val DionysusSurfaceVariant = Color(0xFF2A1C24) // raised wine
val DionysusOnSurface = Color(0xFFF0E9DD)     // parchment
val DionysusOnSurfaceVariant = Color(0xFFB8AC9B) // muted parchment
val DionysusOutline = Color(0x3DC9A24A)        // gold hairline at rest (~24% alpha)
val DionysusError = Color(0xFFE5544B)
